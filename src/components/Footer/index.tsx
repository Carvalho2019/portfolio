      ...
      <div className={styles.container}>
        <div className={styles.main}>
          <div className={styles.brand}>
            <a href="#home" className={styles.logo} aria-label="Clésio Carvalho - Home">
              ...
              <span className={styles.logoText}>Clésio Carvalho</span>
            </a>
          ...
          <nav className={styles.links} aria-label="Footer navigation">
            ...
            <div className={styles.linkGroup}>
              ...
              <ul role="list">
                <li>
                  <a href="https://github.com/Carvalho2019" target="_blank" rel="noopener noreferrer">
                    GitHub
                  </a>
                </li>
                <li>
                  <a href="https://www.linkedin.com/in/clesio-carvalho/" target="_blank" rel="noopener noreferrer">
                    LinkedIn
                  </a>
                </li>
                <li>
                  <a href="https://www.instagram.com/cesario_miguel15/" target="_blank" rel="noopener noreferrer">
                    Instagram
                  </a>
                </li>
                <li>
                  <a href="https://dribbble.com/laudio" target="_blank" rel="noopener noreferrer">
                    Dribbble
                  </a>
                </li>
              </ul>
        ...
        <div className={styles.bottom}>
          <p className={styles.copyright}>
            &copy; {currentYear} Clésio Carvalho. Built with React, Next.js & TypeScript.
          </p>
